            ...
            @else
                <div class="flex items-center space-x-4">
                    <div class="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center">
                        <img src="{{ asset('storage/icons-svg/user.svg') }}" alt="Usuario invitado" title="Usuario invitado"
                            class="w-6 h-6 text-gray-600">
                    </div>
                    <div>
            ...
            <ul class="space-y-2">
                ...
                <li class="mobile-menu-item">
                    <a href="{{ route('home') }}"
                        ...
                        <img src="{{ asset('storage/icons-svg/home.svg') }}" alt="Inicio" title="Inicio"
                ...
                <li class="mobile-menu-item">
                    <a href="{{ route('product.index') }}"
                        ...
                        <img src="{{ asset('storage/icons-svg/shopping-bag.svg') }}" alt="Productos" title="Productos"
                            class="w-5 h-5 text-red-600">
                ...
                <li class="mobile-menu-item">
                    <a href="{{ route('blog.index') }}"
                        ...
                        <img src="{{ asset('storage/icons-svg/newspaper.svg') }}" alt="Blog" title="Blog"
                            class="w-5 h-5 text-red-600">
                ...
                <li class="mobile-menu-item">
                    <a href="{{ route('about') }}"
                        ...
                        <img src="{{ asset('storage/icons-svg/user.svg') }}" alt="Acerca de" title="Acerca de"
                            class="w-5 h-5 text-red-600">
                ...
                @auth
                    ...
                    <li class="mobile-menu-item">
                        <button id="account-toggle"
                            ...
                            <div class="flex items-center space-x-3">
                                <img src="{{ asset('storage/icons-svg/user.svg') }}" alt="Mi Cuenta" title="Mi Cuenta"
                                    class="w-5 h-5 text-red-600">
                                <span>Mi Cuenta</span>
                            </div>
                            <img src="{{ asset('storage/icons-svg/chevron-down.svg') }}" alt="Desplegar menú"
                                title="Desplegar menú" id="account-arrow"
                    ...
                    <li class="mobile-menu-item">
                        <a href="#"
                            ...
                            <img src="{{ asset('storage/icons-svg/question-circle.svg') }}" alt="Ayuda" title="Ayuda"
                                class="w-5 h-5 text-red-600">
                    ...
                    <li class="mobile-menu-item">
                        <button id="services-toggle"
                            class="w-full flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 text-gray-700">
                            <div class="flex items-center space-x-3">
                                <img src="{{ asset('storage/icons-svg/star.svg') }}" alt="Servicios" title="Servicios"
                                    class="w-5 h-5 text-red-600">
                                <span>Servicios</span>
                            </div>
                            <img src="{{ asset('storage/icons-svg/chevron-down.svg') }}" alt="Desplegar servicios"
                                title="Desplegar servicios" id="services-arrow"
                                class="w-4 h-4 transform transition-transform duration-200">
                        </button>
                ...
                @else
                    ...
                    <li class="mobile-menu-item">
                        <a href="{{ route('auth.login.show') }}"
                            ...
                            <img src="{{ asset('storage/icons-svg/login.svg') }}" alt="Iniciar Sesión"
                                title="Iniciar Sesión" class="w-5 h-5 text-red-600">
                    ...
                    <li class="mobile-menu-item">
                        <a href="{{ route('auth.register.show') }}"
                            ...
                            <img src="{{ asset('storage/icons-svg/user-plus.svg') }}" alt="Registrarse"
                                title="Registrarse" class="w-5 h-5">
