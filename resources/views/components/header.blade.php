            ...
            <ul class="space-y-2">
                ...
                <li class="mobile-menu-item">
                    <a href="{{ route('home') }}"
                        ...
                        <span
                            class="text-gray-800 group-hover:text-red-600 transition-colors duration-200">Inicio</span>
                    </a>
                </li>
                ...
                <li class="mobile-menu-item">
                    <a href="{{ route('product.index') }}"
                        ...
                        <span
                            class="text-gray-800 group-hover:text-red-600 transition-colors duration-200">Productos</span>
                    </a>
                </li>
