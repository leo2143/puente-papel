...
<section class="product-grid-section rounded-2xl shadow-lg overflow-hidden mx-4 my-6">
    ...
    <div class="p-6">
        <div class="grid {{ $gridClasses }} gap-6">
            ...
            <article class="product-card bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group">
                {{-- Imagen del producto --}}
                <div class="relative overflow-hidden">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center">
                        <button class="opacity-0 group-hover:opacity-100 bg-white text-gray-800 px-4 py-2 rounded-lg font-medium transition-all duration-300 transform translate-y-4 group-hover:translate-y-0">
                            Ver detalles
                        </button>
                    </div>
                </div>
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-xl font-bold text-gray-800">
                            ${{ number_format($product['price'] ?? 30000, 0, ',', '.') }}
                        </span>

                        <button class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 text-sm">
                            Agregar
                        </button>
                    </div>
                </div>
