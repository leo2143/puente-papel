        ...
        <main class="h-full">
            <div class="flex h-full">
                ...
                <aside id="admin-sidebar"
                    class="hidden lg:flex lg:flex-col w-64 bg-white shadow-lg border-r border-gray-200 relative z-40 transition-all duration-300 ease-in-out h-screen">
                    {{-- Header del sidebar con botón toggle --}}
                    <div class="flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0">
                        <span class="text-lg font-semibold text-gray-800 sidebar-text">Panel Admin</span>
                        <button id="sidebar-toggle"
                            class="p-2 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                            aria-label="Colapsar sidebar">
                            <svg class="w-5 h-5 text-gray-600 transition-transform duration-300" fill="none"
