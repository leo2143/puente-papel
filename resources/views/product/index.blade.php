    ...
    <section class="container mx-auto p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($product as $producto)
                    <a href="{{ route('product.show', $producto) }}">
                        ...
                        <div
                            class="bg-pink-50 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-pink-200 ">
        ...
        @else
            <div class="bg-pink-50 px-8 py-12 rounded-2xl max-w-2xl mx-auto border-2 border-pink-200">
                <h1 class="text-xl text-gray-800 mb-4 text-center">No hay productos disponibles</h1>
