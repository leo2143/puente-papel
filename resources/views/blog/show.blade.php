<x-layouts.main>
    ...
    <article class="max-w-4xl mx-auto px-4 py-8">
            ...
            <div class="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-6">
                @if ($post->user)
                    <div class="flex items-center space-x-2">
                        <div
                            class="w-8 h-8 bg-pink-300 rounded-full flex items-center justify-center border border-pink-400">
        ...
        <div class="bg-pink-50 px-8 py-6 rounded-2xl border-2 border-pink-200">
            <div class="prose prose-lg prose-pink max-w-none prose-headings:text-gray-800 prose-p:text-gray-700">
                {!! $post->contentHtml !!}
            </div>
        </div>
