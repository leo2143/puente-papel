<x-layouts.admin>
    ...
    @php
        $breadcrumbs = [
            ...
            ['name' => 'Crear Post', 'url' => '#', 'active' => true]
        ];
    @endphp
            ...
            <div class="space-y-6">
                ...
                <div class="bg-blue-50 p-6 rounded-lg border border-blue-200">
                    ...
                    <ul class="text-sm text-blue-700 space-y-2">
                        ...
                        <li>• Usa el formato Markdown para mejor legibilidad</li>
                        <li>• Utiliza **texto en negrita** y *texto en cursiva*</li>
                        <li>• Crea listas con - o 1. para enumerar</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const editor = new EditorJS({
                ...
                data: @json(old('content') ? json_decode(old('content')) : null)
            });
