<x-layouts.admin>
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Gestionar Blog</h1>
    ...
    <div class="bg-white p-4 rounded-lg shadow-lg border border-gray-200 mb-6">
        <form method="GET" class="flex items-center space-x-4">
            ...
            @if(request('search') || request('status'))
                <a href="{{ route('admin.blog.index') }}" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors duration-200">
                    Limpiar
                </a>
            @endif
        </form>
