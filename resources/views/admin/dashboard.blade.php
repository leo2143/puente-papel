<x-layouts.admin>
    <section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-red-700 to-red-900 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
                <img src="{{ asset('storage/images/puente_papel_icon.png') }}" 
                     alt="puente papel logo" 
            ...
            {{-- Total de Ventas --}}
            <div class="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
                <img src="{{ asset('storage/images/puente_papel_icon.png') }}" 
                     alt="puente papel logo" 
                     class="absolute -bottom-6 -right-6 w-28 h-25 ">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-end gap-2">
                        <span class="text-5xl font-bold">${{ number_format($stats['total_sales'], 2, ',', '.') }}</span>
                    </div>
